...
def summarize_period(checkins):
    """Simple, transparent aggregate stats - not a black box."""
    total = len(checkins)
    if total == 0:
        return {}
    return {
...
{{
  ...
  "reasoning": "brief explanation of why this is or isn't a meaningful pattern change from THIS person's baseline"
}}
